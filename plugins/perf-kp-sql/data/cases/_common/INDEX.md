...
| linux-fs-mmap-metadata-archiver-01 | other | Linux FS metadata syscall hotspot in mmap-based archiver workload | 1334 |
| glibc-malloc-allocator-hot-stack-01 | other | glibc malloc allocator tracing hot stack — application allocation code path | 1362 |
| linux-mm-brk-heap-expansion-01 | other | brk() syscall hot frame — heap expansion code path | 1390 |
| linux-mm-mmap-vm-growth-01 | other | mmap() syscall hot frame — VM mapping growth code path | 1418 |
| linux-mm-page-fault-physical-population-01 | other | page fault hot frame — physical memory population code path | 1446 |
| linux-block-offwake-disk-io-block-completion-01 | other | Off-Wake flame graph stack chain: disk I/O block completion interrupt waking blocked vfs_read() | 1474 |
