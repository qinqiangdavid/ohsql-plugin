...
CHECKS = [
    ...
    ("chk-shared-buffers", "shared_buffers", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW shared_buffers;\""),
    ("chk-work-mem", "work_mem", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW work_mem;\""),
    ("chk-rewrite-rule", "rewrite_rule", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW rewrite_rule;\""),
    ("chk-enable-hashjoin", "enable_hashjoin", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_hashjoin;\""),
    ("chk-enable-nestloop", "enable_nestloop", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_nestloop;\""),
    ("chk-enable-mergejoin", "enable_mergejoin", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_mergejoin;\""),
    ("chk-enable-sort", "enable_sort", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_sort;\""),
    ("chk-best-agg-plan", "best_agg_plan", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW best_agg_plan;\""),
    ("chk-a-format-load-with-constraints-violation", "a_format_load_with_constraints_violation", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW a_format_load_with_constraints_violation;\""),
    ("chk-cost-param", "cost_param", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW cost_param;\""),
    ("chk-skew-option", "skew_option", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW skew_option;\""),
    ("chk-thread-pool-attr", "thread_pool_attr", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW thread_pool_attr;\""),
    ("chk-default-statistics-target", "default_statistics_target", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW default_statistics_target;\""),
    ("chk-behavior-compat-options", "behavior_compat_options", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW behavior_compat_options;\""),
    ("chk-enable-fast-query-shipping", "enable_fast_query_shipping", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_fast_query_shipping;\""),
    ("chk-recovery-parse-workers", "recovery_parse_workers", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW recovery_parse_workers;\""),
    ("chk-recovery-redo-workers", "recovery_redo_workers", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW recovery_redo_workers;\""),
    ("chk-enable-index-nestloop", "enable_index_nestloop", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_index_nestloop;\""),
    ("chk-enable-indexscan", "enable_indexscan", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_indexscan;\""),
    ("chk-max-process-memory", "max_process_memory", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW max_process_memory;\""),
    ("chk-qrw-inlist2join-optmode", "qrw_inlist2join_optmode", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW qrw_inlist2join_optmode;\""),
    ("chk-fetchsize", "fetchSize", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW fetchSize;\""),
    ("chk-period", "period", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW period;\""),
    ("chk-ttl", "ttl", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW ttl;\""),
    ("chk-disk-cache-max-size", "disk_cache_max_size", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW disk_cache_max_size;\""),
    ("chk-disk-cache-dual-write-option", "disk_cache_dual_write_option", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW disk_cache_dual_write_option;\""),
    ("chk-min-batch-rows", "min_batch_rows", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW min_batch_rows;\""),
    ("chk-autovacuum", "autovacuum", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW autovacuum;\""),
    ("chk-autovacuum-vacuum-cost-delay", "autovacuum_vacuum_cost_delay", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW autovacuum_vacuum_cost_delay;\""),
    ("chk-autovacuum-max-workers", "autovacuum_max_workers", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW autovacuum_max_workers;\""),
    ("chk-autovacuum-naptime", "autovacuum_naptime", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW autovacuum_naptime;\""),
    ("chk-max-active-statements", "max_active_statements", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW max_active_statements;\""),
    ("chk-autovacuum-max-workers-hstore", "autovacuum_max_workers_hstore", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW autovacuum_max_workers_hstore;\""),
    ("chk-enable-codegen", "enable_codegen", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_codegen;\""),
    ("chk-enable-numa-bind", "enable_numa_bind", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_numa_bind;\""),
    ("chk-abnormal-check-general-task", "abnormal_check_general_task", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW abnormal_check_general_task;\""),
    ("chk-resource-track-level", "resource_track_level", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW resource_track_level;\""),
    ("chk-track-activities", "track_activities", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW track_activities;\""),
    ("chk-connectiontimeout", "connectionTimeOut", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW connectionTimeOut;\""),
    ("chk-lockwait-timeout", "lockwait_timeout", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW lockwait_timeout;\""),
    ("chk-psort-work-mem", "psort_work_mem", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW psort_work_mem;\""),
    ("chk-enable-delta", "ENABLE_DELTA", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW ENABLE_DELTA;\""),
    ("chk-resource-pool-cpu-dedicated-quota", "resource_pool.cpu_dedicated_quota", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW resource_pool.cpu_dedicated_quota;\""),
    ("chk-temp-file-limit", "temp_file_limit", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW temp_file_limit;\""),
    ("chk-sequence-cache", "sequence.cache", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW sequence.cache;\""),
    ("chk-query-dop", "query_dop", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW query_dop;\""),
    ("chk-cstore-buffers", "cstore_buffers", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW cstore_buffers;\""),
    ("chk-comm-max-stream", "comm_max_stream", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW comm_max_stream;\""),
    ("chk-vacuum-defer-cleanup-age", "vacuum_defer_cleanup_age", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW vacuum_defer_cleanup_age;\""),
    ("chk-enable-stream-operator", "enable_stream_operator", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW enable_stream_operator;\""),
    ("chk-table-skewness-warning-threshold", "table_skewness_warning_threshold", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW table_skewness_warning_threshold;\""),
    ("chk-table-skewness-warning-rows", "table_skewness_warning_rows", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW table_skewness_warning_rows;\""),
    ("chk-session-timeout", "session_timeout", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW session_timeout;\""),
    ("chk-max-connections", "max_connections", "gaussdb-guc-param", "gsql -d postgres -c \"SHOW max_connections;\""),
]
