...
//
// 用法: node match-collect-to-cases.mjs --collect <out-dir> [--checklist <checklist.ndjson>]
...
if (IS_MAIN) {
  ...
  for (const c of checks) {
    ...
    const base = { check_id: c.check_id, topology: topo, linked_case_ids: c.linked_case_ids || [] };
    if (cmp === true) {
